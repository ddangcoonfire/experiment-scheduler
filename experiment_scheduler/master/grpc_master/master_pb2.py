...
EditTask = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "TaskEnvEntry": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                "DESCRIPTOR": _EDITTASK_TASKENVENTRY,
                "__module__": "master_pb2"
                # @@protoc_insertion_point(class_scope:experiment_scheduler.task_manager.grpc_task_manager.EditTask.TaskEnvEntry)
            },
        ),
...
_sym_db.RegisterMessage(EditTask.TaskEnvEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MASTER._serialized_start = 1485
    _MASTER._serialized_end = 2470
